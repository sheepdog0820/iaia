...
| 自動検査 | 性能改善82712c24を含む[6b70d517のCI](DATE_POLL_PERFORMANCE_2026-09-12.md)はPR側6ジョブ成功、push側はFirefoxの登録遷移で1 flakyとなり不合格。隔離環境の当該テスト10回は成功したが原因未確定。後続文書コミットbd0c7f87のCIは確認時点で実行中。稼働版はf97c7809で、候補のmain/AWS反映は未実施 |
