...
## 現在の完成度（要約）
- コア機能: CoC6版/7版の作成・保存・参照の主要機能は完了（成長記録など6版専用の項目あり）
...
- [完了] 居住地
- [完了] 精神障害（6版専用）
- [完了] キャラクター画像（複数枚アップロード、メイン指定、並び替え、削除。詳細仕様は `docs/character_sheet/CHARACTER_MULTIPLE_IMAGES_SPECIFICATION.md` を参照）
...
このキャラクターシート機能は**クトゥルフ神話TRPG 6版/7版**が対象です。他のTRPGシステム（D&D、ソード・ワールド等）のキャラクターシートには対応していません。
