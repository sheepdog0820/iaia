...
**シナリオ推奨技能の一括指定**
- シナリオの推奨技能または準推奨技能に `戦闘技能` を指定した場合、近接・回避・投擲系の技能をまとめて推奨として扱う
- 6版では上記7技能、7版では回避、近接戦闘、投擲の3技能へ展開する
- `重火器` を指定した場合、拳銃・ライフルなどの射撃系技能をまとめて推奨として扱う
- 6版では上記5技能、7版では射撃（拳銃）、射撃（ライフル／ショットガン）の2技能へ展開する
- 個別技能と併記した場合は重複を除き、推奨技能の指定を準推奨技能より優先する
