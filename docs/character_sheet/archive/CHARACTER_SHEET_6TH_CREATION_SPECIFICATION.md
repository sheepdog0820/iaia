...
> アーカイブ資料: この文書の技術バージョンは作成当時の記録です。現在の仕様と技術スタックは `docs/specifications/CURRENT_WEBAPP_FEATURES.md` と `docs/character_sheet/CHARACTER_SHEET_6TH_EDITION_SPECIFICATION.md` を参照してください。
