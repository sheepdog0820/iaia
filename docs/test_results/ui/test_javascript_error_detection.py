...
if SELENIUM_AVAILABLE:
    ...
    class JavaScriptErrorDetectionTest(StaticLiveServerTestCase):
        ...
        def login(self):
            ...
            # Wait for redirect
            WebDriverWait(self.selenium, 10).until(EC.url_contains("/accounts/profile/"))
        ...
        def test_page_load_no_errors(self):
            ...
            WebDriverWait(self.selenium, 10).until(EC.presence_of_element_located((By.ID, "character_name")))
        ...
        def test_ability_score_changes_no_errors(self):
            ...
            dex_field = WebDriverWait(self.selenium, 10).until(EC.presence_of_element_located((By.ID, "dex")))
        ...
        def test_skill_allocation_no_errors(self):
            ...
            edu_field = WebDriverWait(self.selenium, 10).until(EC.presence_of_element_located((By.ID, "edu")))
            edu_field.clear()
            ...
            try:
                skill_input = self.selenium.find_element(
                    By.CSS_SELECTOR, '[data-skill="archaeology"].skill-occupation-input'
                )
                skill_input.clear()
        ...
        def test_custom_base_value_editing_no_errors(self):
            ...
            WebDriverWait(self.selenium, 10).until(EC.presence_of_element_located((By.ID, "skillsList")))
