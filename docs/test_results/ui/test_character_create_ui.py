...
class CharacterCreateUITest(TestCase):
    ...
    def test_form_submission_creates_character(self):
        ...
        response = self.client.post("/api/character-sheets/", data=json.dumps(data), content_type="application/json")
...
if SELENIUM_AVAILABLE:
    ...
    class CharacterCreateSeleniumTest(StaticLiveServerTestCase):
        ...
        def test_dice_rolling_functionality(self):
            ...
            WebDriverWait(self.selenium, 10).until(EC.presence_of_element_located((By.ID, "str")))
        ...
        def test_derived_stats_calculation(self):
            ...
            # Set ability values
            WebDriverWait(self.selenium, 10).until(EC.presence_of_element_located((By.ID, "con")))
        ...
        def test_successful_character_creation(self):
            ...
            self.assertTrue(CharacterSheet.objects.filter(name="Selenium Test Character").exists())
        ...
        def test_responsive_layout(self):
            ...
            self.assertTrue(self.selenium.find_element(By.ID, "character_name").is_displayed())
