...
router.register(
    ...
    notification_views.UserNotificationPreferencesViewSet,
    basename="notificationpreferences",
)
...
urlpatterns = [
    ...
    path(
        "sessions/participating-scenarios/",
        views.ParticipatingScenarioChoicesView.as_view(),
        name="participating_scenarios",
    ),
    ...
    path(
        "analytics/dashboard/",
        analytics_views.SessionAnalyticsDashboardView.as_view(),
        name="session_analytics_dashboard",
    ),
    ...
    path(
        "handouts/<int:handout_id>/attachments/",
        attachment_views.HandoutAttachmentListCreateView.as_view(),
        name="handout_attachments",
    ),
    path(
        "attachments/<int:pk>/",
        attachment_views.HandoutAttachmentDetailView.as_view(),
