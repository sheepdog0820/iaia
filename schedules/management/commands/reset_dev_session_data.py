...
class Command(BaseCommand):
    ...
    def _add_occurrences_and_attendance(self) -> None:
        ...
        if group and gm:
            ...
            for slot, username in enumerate(
                ["investigator1", "investigator2", "investigator3", "investigator4"], start=1
            ):
            ...
            if primary:
                primary.participants.set(
                    User.objects.filter(username__in=["keeper1", "investigator1", "investigator2"])
                )
