        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(blank=True, help_text="カスタム間隔（日数）", null=True),
                ),
                ...
                (
                    ...
                    models.PositiveIntegerField(default=4, help_text="何週間先まで自動生成するか"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="候補日時（セッション/オカレンスが未確定の場合）", null=True
                    ),
                ),
                (
                    "status",
