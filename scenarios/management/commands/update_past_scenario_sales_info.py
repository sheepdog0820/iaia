...
SCENARIO_SALES_INFOS = (
    info(
        ...
        recommended_players='4人', min_players=4, max_players=4, player_count=4, estimated_time=12,
        setting_era='現代', setting_location='現代イタリア・エテルノ美術館', scenario_style='秘匿HO/クローズド',
        recommended_skills='目星、聞き耳、図書館', semi_recommended_skills='ほかの言語（英語）または ほかの言語（イタリア語）',
        investigator_requirements='秘匿HOに沿った探索者。公開HOは童子、篤学者、美術家、異邦人。',
        content_warnings='一部グロテスクな表現、クトゥルフ神話的恐怖、暴力的描写、探索者同士の対立が発生する可能性あり。',
        lost_rate='本文参照', combat_level='本文参照', pvp_level='可能性あり',
        scenario_tags='CoC6,秘匿HO,クローズド,現代イタリア,美術館',
    ),
    info(
        '同じ空には昇れない', ['同じ空には昇れない', '同じ空には昇れない【第三陣】'],
        author='多箱屋商会', url='https://booth.pm/ja/items/5202796',
        summary='昼に嫌われた吸血鬼と、夜に嫌われた人間を描く、現代日本想定の新規2人固定・秘匿HO型一本道シティシナリオ。',
        public_info='ある日の夕暮れ、勤務先のコンビニへ忘れ物を取りに戻る道中、道端で行き倒れている吸血鬼を見つける。',
        recommended_players='新規2人固定', min_players=2, max_players=2, player_count=2, estimated_time=12,
        setting_era='現代', setting_location='現代日本', scenario_style='秘匿HO型一本道シティ',
        recommended_skills='HOごとに記載', semi_recommended_skills='',
        investigator_requirements='新規2人固定。公開HOはHO太陽「君は目覚めたい」、HO月「君は眠りたい」。',
        content_warnings='ロストあり。詳細は販売ページおよび本文参照。',
        lost_rate='有り', combat_level='本文参照', pvp_level='本文参照',
        scenario_tags='CoC6,秘匿HO,2PL,シティ,吸血鬼',
    ),
    info(
        'グレイブレコード', ['グレイブレコード'],
        author='酸味屋', url='https://booth.pm/ja/items/7173134',
        ...
        recommended_players='2PL・4PC', min_players=2, max_players=4, player_count=2, estimated_time=9,
        setting_era='現代日本 / 西暦967年の架空王国', setting_location='現代日本・ミズガリズル王国', scenario_style='3話構成キャンペーン',
        recommended_skills='目星、図書館。章により聞き耳、交渉技能、戦闘技能など。', semi_recommended_skills='',
        investigator_requirements='PL1人につき2人の探索者を作成。現代日本編は新規・継続可、別章は新規限定の記載あり。',
        content_warnings='章によりロスト率が異なる。詳細は本文参照。',
        lost_rate='低〜中高/高', combat_level='章によりあり', pvp_level='本文参照',
        scenario_tags='CoC6,2PL,4PC,キャンペーン,終末,現代日本,架空王国',
    ),
    info(
        '狂気山脈', ['狂気山脈', '狂気山脈　第一登山隊'],
        author='FORESTLIMIT Shop', url='https://booth.pm/ja/items/1071516',
        ...
        recommended_players='3〜4人程度', min_players=3, max_players=4, player_count=4,
        setting_era='現代', setting_location='南極・狂気山脈', scenario_style='登山/キャンペーン',
        recommended_skills='登山・探索に関わる技能。詳細はシナリオ本文参照。', semi_recommended_skills='',
        investigator_requirements='登山家たる探索者を想定。4人用調整版あり。',
        content_warnings='クトゥルフ神話的恐怖、極地登山、遭難・危険環境を扱う。詳細は本文参照。',
        lost_rate='本文参照', combat_level='本文参照', pvp_level='本文参照',
        scenario_tags='CoC6,CoC7,登山,南極,キャンペーン,無料',
    ),
    info(
        'モーンガータの魔法使い', ['モーンガータの魔法使い', 'モーンガータの魔法使い《前半》', 'モーンガータの魔法使い《後半》', 'モーンガーターの魔法使い'],
        author='酸味屋', url='https://booth.pm/ja/items/5895208',
        ...
        recommended_players='2PL', min_players=2, max_players=2, player_count=2, estimated_time=15,
        setting_era='ファンタジー/魔法学園', setting_location='モーンガータ魔法学園', scenario_style='5話構成キャンペーン/秘匿HO',
        recommended_skills='目星、聞き耳、図書館、交渉技能', semi_recommended_skills='',
        ...
        lost_rate='中〜高', combat_level='本文参照', pvp_level='可能性あり',
        scenario_tags='CoC6,秘匿HO,2PL,キャンペーン,魔法学園',
    ),
    info(
        '犬猫戦争は、終わらせない。', ['犬猫戦争は、終わらせない。', '犬猫戦争は終わらせない'],
        author='ろっしなりお電子書店', url='https://booth.pm/ja/items/2913315',
        ...
        recommended_players='2人', min_players=2, max_players=2, player_count=2,
        setting_era='現代', setting_location='現代日本・犬猫学園秀才大学', scenario_style='秘匿HO/対戦型協力',
        recommended_skills='シナリオ本文参照', semi_recommended_skills='',
        investigator_requirements='公開HOはHO1「誰よりも優秀な犬」、HO2「誰よりも気高い猫」。',
        content_warnings='秘匿HOあり。対戦型協力シナリオ。詳細は本文参照。',
        lost_rate='低', combat_level='本文参照', pvp_level='対戦型協力',
        scenario_tags='CoC6,秘匿HO,2PL,対戦型協力,学園',
    ),
    info(
        '怪祓-カイブツ-', ['怪祓-カイブツ-'],
        author='はなむけ屋', url='https://booth.pm/ja/items/7536096',
        ...
        recommended_players='2人', min_players=2, max_players=2, player_count=2, estimated_time=45,
        setting_era='現代', setting_location='日本', scenario_style='秘匿HO/連作',
        recommended_skills='秘匿HOに記載', semi_recommended_skills='',
    ...
    info(
        '獣人ガストロノミー', ['獣人ガストロノミー', '獣人ガストロノミー 事前導入HO3.4', '獣人ガストロノミー 事前導入HO1,2'],
        author='犬小屋スタジオ', url='https://booth.pm/ja/items/5844289',
        ...
        recommended_players='2人と2匹', min_players=2, max_players=4, player_count=2, estimated_time=16,
        setting_era='異世界/獣人社会', setting_location='人間が食料の世界', scenario_style='秘匿HO/ダブルバディ',
        recommended_skills='HO毎に異なる', semi_recommended_skills='',
        investigator_requirements='新規限定。4つのHOを扱う。',
        content_warnings='一部のHOが食されることがあります。人間が食料として扱われる設定を含む。',
        lost_rate='中', combat_level='本文参照', pvp_level='本文参照',
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--create-missing', action='store_true', help='Create canonical records when no scenario matches.')
            ...
            for sales_info in SCENARIO_SALES_INFOS:
                ...
                for scenario in scenarios:
                    ...
                    if dry_run:
                        ...
                        stats['updated'] += 1
                        self.stdout.write(self.style.SUCCESS(f"updated: {scenario.title} fields={','.join(changed_fields)}"))
                    else:
                        stats['unchanged'] += 1
            if dry_run:
