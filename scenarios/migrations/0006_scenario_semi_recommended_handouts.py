    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handout_number', models.IntegerField(blank=True, choices=[(1, 'HO1'), (2, 'HO2'), (3, 'HO3'), (4, 'HO4')], null=True)),
                ('assigned_player_slot', models.IntegerField(blank=True, choices=[(1, 'プレイヤー1'), (2, 'プレイヤー2'), (3, 'プレイヤー3'), (4, 'プレイヤー4')], null=True)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('scenario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='handout_templates', to='scenarios.scenario')),
            ],
            options={
