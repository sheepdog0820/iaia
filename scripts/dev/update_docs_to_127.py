...
DOCS_TO_UPDATE = [
    "docs/setup/oauth/GOOGLE_OAUTH_STATE_ERROR_FIX.md",
    "docs/api/GOOGLE_AUTH_GUIDE.md",
    "docs/setup/oauth/GOOGLE_OAUTH_8000_PORT_SETUP.md",
    "docs/setup/oauth/GOOGLE_CLOUD_CONSOLE_CHECK.md",
    "docs/setup/oauth/GOOGLE_OAUTH_LOGIN_GUIDE.md",
    "docs/setup/oauth/GOOGLE_OAUTH_REDIRECT_URI_FIX.md",
    "docs/setup/oauth/OAUTH_REGISTRATION_GUIDE.md",
]
