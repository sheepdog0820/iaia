...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--username", type=str, default="testuser", help="キャラクターを作成するユーザー名")
        parser.add_argument("--count", type=int, default=3, help="作成するキャラクター数")
    ...
    def create_character_image(self, text, color=(100, 100, 100), size=(400, 600)):
        ...
        draw.rectangle(
            [size[0] // 2 - body_width // 2, body_top, size[0] // 2 + body_width // 2, body_top + body_height],
            fill=icon_color,
        )
    ...
    def handle(self, *args, **options):
        ...
        user, created = User.objects.get_or_create(
            username=username, defaults={"email": f"{username}@example.com", "nickname": f"テストユーザー{username}"}
        )
        ...
        test_characters = [
            {
                ...
                "birthplace": "東京都",
                "residence": "東京都渋谷区",
                "abilities": {"str": 11, "con": 13, "pow": 14, "dex": 12, "app": 13, "siz": 11, "int": 15, "edu": 16},
                "skills": [
                    ("言いくるめ", 5, 30, 15),
                    ("図書館", 25, 40, 10),
                    ("写真術", 10, 35, 5),
            ...
            },
            {
                ...
                "birthplace": "京都府",
                "residence": "東京都文京区",
                "abilities": {"str": 9, "con": 11, "pow": 17, "dex": 10, "app": 10, "siz": 12, "int": 16, "edu": 18},
                "skills": [
                    ("オカルト", 5, 45, 20),
                    ("歴史", 20, 40, 10),
                    ("図書館", 25, 35, 10),
            ...
            },
            {
                ...
                "birthplace": "大阪府",
                "residence": "東京都新宿区",
                "abilities": {"str": 13, "con": 14, "pow": 13, "dex": 15, "app": 11, "siz": 13, "int": 14, "edu": 13},
                "skills": [
                    ("隠れる", 10, 35, 15),
                    ("聞き耳", 20, 40, 10),
                    ("忍び歩き", 10, 35, 15),
        ...
        with transaction.atomic():
            for i in range(count):
                ...
                self.stdout.write(self.style.SUCCESS(f"キャラクター {char_name} を作成しました（画像3枚付き）"))
                created_count += 1
