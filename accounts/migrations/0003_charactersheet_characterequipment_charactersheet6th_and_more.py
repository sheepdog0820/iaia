    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "character_image",
                    models.ImageField(blank=True, upload_to="character_sheets/", verbose_name="キャラクター画像"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "item_type",
                    models.CharField(
                        choices=[("weapon", "武器"), ("armor", "防具"), ("item", "アイテム")], max_length=10
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "character_sheet",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="skills", to="accounts.charactersheet"
                    ),
                ),
            ],
            options={
