...
from ..views.character_image_views import (
    CharacterImageBackgroundRemovalStatusView,
    CharacterImageBackgroundRemovalView,
...
urlpatterns = [
    ...
    path(
        "character-images/remove-background/",
        CharacterImageBackgroundRemovalView.as_view(),
        name="character-image-remove-background",
    ),
    path(
        "character-images/remove-background/jobs/<uuid:job_id>/",
        CharacterImageBackgroundRemovalStatusView.as_view(),
        name="character-image-background-removal-status",
    ),
