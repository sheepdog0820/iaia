...
class CustomSkillAdditionAPITestCase(APITestCase):
    ...
    def test_custom_skill_api_creation(self):
        ...
        response = self.client.post(
            f"/api/accounts/character-sheets/{self.character.id}/skills/", skill_data, format="json"
        )
    ...
    def test_custom_skill_api_authentication_required(self):
        ...
        skill_data = {"skill_name": "制作（木工）", "base_value": 5}
    ...
    def test_custom_skill_api_permission_check(self):
        ...
        skill_data = {"skill_name": "芸術（彫刻）", "base_value": 5}

        response = self.client.post(
            f"/api/accounts/character-sheets/{other_character.id}/skills/", skill_data, format="json"
        )
    ...
    def test_custom_skill_api_validation(self):
        ...
        # 技能名が空の場合
        skill_data = {"skill_name": "", "base_value": 5}  # 空文字
    ...
    def test_bulk_custom_skill_creation(self):
        ...
        response = self.client.patch(
            f"/api/accounts/character-sheets/{self.character.id}/skills/bulk_update/", skills_data, format="json"
        )
