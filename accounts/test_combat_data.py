...
class CombatDataAPITestCase(APITestCase):
    ...
    def test_create_weapon_api(self):
        ...
        response = self.client.post(
            f"/accounts/character-sheets/{self.character.id}/equipment/", weapon_data, format="json"
        )
    ...
    def test_create_armor_api(self):
        ...
        response = self.client.post(
            f"/accounts/character-sheets/{self.character.id}/equipment/", armor_data, format="json"
        )
    ...
    def test_get_weapons_list_api(self):
        ...
        response = self.client.get(f"/accounts/character-sheets/{self.character.id}/equipment/?type=weapon")
    ...
    def test_update_weapon_api(self):
        ...
        response = self.client.patch(
            f"/accounts/character-sheets/{self.character.id}/equipment/{weapon.id}/", update_data, format="json"
        )
