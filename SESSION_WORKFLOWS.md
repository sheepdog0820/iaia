...
- 「テンプレート登録」で現在の入力を保存できます
- テンプレート登録ダイアログの「詳細編集」から、現在値を引き継いだテンプレート管理画面を開けます
- 既存テンプレートを選ぶと、基本情報・グループ・シナリオが作成フォームへ反映されます
...
- 一覧画面と詳細画面の編集フォームは共通レイアウトです
- グループと関連シナリオは編集時に参照表示となり、新規作成時に設定します
