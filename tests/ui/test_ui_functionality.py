...
class UIFunctionalityTester:
    ...
    def test_static_files(self):
        """静的ファイルの読み込みテスト"""
        static_files = [("/static/css/arkham.css", "CSS"), ("/static/js/arkham.js", "JavaScript")]
    ...
    def test_responsive_content(self):
        ...
        try:
            ...
            responsive_elements = ["navbar-toggler", "navbar-collapse", "container-fluid", "col-md-", "col-lg-"]
    ...
    def test_form_elements(self):
        """フォーム要素の存在確認"""
        pages_with_forms = [("/accounts/login/", "ログインフォーム"), ("/accounts/demo/", "デモフォーム")]
    ...
    def test_javascript_functionality(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # JavaScript機能の確認
                js_features = ["function", "addEventListener", "fetch", "querySelector", "CSRF"]
    ...
    def test_error_handling(self):
        """エラーハンドリングのテスト"""
        error_urls = ["/nonexistent-page/", "/accounts/invalid-endpoint/", "/api/invalid-api/"]
