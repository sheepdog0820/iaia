...
if SELENIUM_AVAILABLE:
    ...
    class CharacterCreateSeleniumTest(StaticLiveServerTestCase):
        ...
        def login(self):
            ...
            login_btn.click()
            WebDriverWait(self.selenium, 10).until(EC.url_contains("/accounts/dev-login/"))
        ...
        def test_roll_all_abilities_sets_values(self):
            ...
            roll_btn = WebDriverWait(self.selenium, 10).until(EC.element_to_be_clickable((By.ID, "rollAllAbilities")))
            roll_btn.click()
            time.sleep(0.5)
