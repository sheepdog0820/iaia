...
class Character6thBasicUITest(TestCase):
    ...
    def test_character_creation_post(self):
        ...
        character = CharacterSheet.objects.filter(user=self.user, name="New Character").first()
...
class Character6thAPIUITest(TestCase):
    ...
    def test_skill_points_summary_api(self):
        ...
        character = create_test_character(self.user, occupation="医師", edu_value=16, int_value=10)
    ...
    def test_ccfolia_export_api(self):
        ...
        character = create_test_character(self.user, name="Export Test", str_value=13)

        # Add a skill
        CharacterSkill.objects.create(character_sheet=character, skill_name="医学", base_value=5, occupation_points=70)
