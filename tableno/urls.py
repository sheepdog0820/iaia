...
from accounts.views import CustomLoginView, CustomSignUpView, GroupInviteLinkJoinView, GroupInviteLinkLandingView
...
urlpatterns = [
    ...
    path(
        "share/characters/<uuid:share_token>/view/",
        FixedSharedCharacterView.as_view(),
        name="fixed-shared-character-view",
    ),
    path(
        "share/scenarios/<uuid:share_token>/view/", FixedSharedScenarioView.as_view(), name="fixed-shared-scenario-view"
    ),
    path("share/sessions/<str:token>/", SharedSessionDetailView.as_view(), name="shared-session-detail"),
    path(
        "share/characters/<str:token>/ccfolia.json",
        SharedCharacterCcfoliaJsonView.as_view(),
        name="shared-character-ccfolia-json",
    ),
    path(
        "share/characters/<str:token>/images/", SharedCharacterImagesView.as_view(), name="shared-character-images-list"
    ),
    path(
        "share/characters/<str:token>/images.zip",
        SharedCharacterImagesZipView.as_view(),
        name="shared-character-images-zip",
    ),
    path(
        "share/characters/<str:token>/preview-image/",
        SharedCharacterPreviewImageView.as_view(),
        name="shared-character-preview-image",
    ),
